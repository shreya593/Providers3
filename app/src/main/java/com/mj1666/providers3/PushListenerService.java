...
public class PushListenerService extends FirebaseMessagingService {
    ...
    public void onNewToken(String token) {
        ...
        Pushnotifications.getPinpointManager(getApplicationContext()).getNotificationClient().registerDeviceToken(token);
    }
    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
        ...
        final NotificationClient notificationClient = Pushnotifications.getPinpointManager(getApplicationContext()).getNotificationClient();
